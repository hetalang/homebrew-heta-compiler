class HetaCompiler < Formula
    ...
    url "https://github.com/hetalang/heta-compiler/releases/download/v0.9.4/heta-compiler-macos.tar.gz"
    sha256 "f338257ae04ab3036e8b82776a46e3cbf66c6cc6d6206882478d22be9579836e"
    license "Apache-2.0"
